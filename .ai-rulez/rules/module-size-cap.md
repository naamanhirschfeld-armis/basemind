...
- The cap exists because basemind already has precedent files that were split (`src/mcp/tools.rs` → `tools.rs` + `helpers.rs`) and the split shape is the project's preferred unit of work.
